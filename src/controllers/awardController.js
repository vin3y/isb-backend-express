    ...
    try {
        ...
        if (req.file) {
            ...
            const oldImageResult = await db.query(
                'SELECT award_image_url FROM awards WHERE id = $1',
                [awardId]
            );
            ...
            updateQuery = `
                UPDATE awards 
                SET award_name = $1, award_year = $2, award_description = $3, 
                    award_image_url = $4, order_index = $5, updated_at = CURRENT_TIMESTAMP 
                WHERE id = $6 
                RETURNING *
            `;
            updateParams = [
            ...
            updateQuery = `
                UPDATE awards 
                SET award_name = $1, award_year = $2, award_description = $3, 
                    order_index = $4, updated_at = CURRENT_TIMESTAMP 
                WHERE id = $5 
                RETURNING *
            `;
            updateParams = [
